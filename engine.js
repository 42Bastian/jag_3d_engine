...
//->
//->	movei	#$e0000c,r0
//->	movei	#tri_ptrs_ram,r1
//->	store	r1,(r0)

//->	movefa	screen0.a,r0
//->	movei	#160*2+10*max_x*2,r1
//->	add	r0,r1
//->	movei	#-1,r2
//->	storew	r2,(r1)
//->	movei	#160*2+20*max_x*2,r1
//->	add	r0,r1
//->	storew	r2,(r1)
//->	movei	#160*2+74*max_x*2,r1
//->	add	r0,r1
//->	storew	r2,(r1)
//->	movei	#(160-64)*2+(74+64)*max_x*2,r1
//->	add	r0,r1
//->	storew	r2,(r1)
