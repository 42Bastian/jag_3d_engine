...
_CAMERA_SPEED	EQU CAMERA_SPEED-CAMERA_X
...
obj_plane:
 ...
 IF TEXTURE <> 0
	.long
sea_tex_0:
	tex_info_shifted 1, 0,0,63,0,63,63
sea_tex_1:
	tex_info_shifted 1, 0,0,63,63,0,63

sea2_tex_0:
	tex_info_shifted 5, 0,0,63,0,63,63
sea2_tex_1:
	tex_info_shifted 5, 0,0,63,63,0,63

grass_tex_0:
	tex_info_shifted 3, 0,0,63,0,63,63
grass_tex_1:
...
texture:
	...
	include "textures/texture.inc"
waves:
	incbin "textures/waves_64x64.cry"
brick:
	incbin "textures/brick_64x64.cry"
grass:
	incbin "textures/grass_64x64.cry"
mandel:
	incbin "textures/marble.cry"
